import { IInventoryRepository, IUserRepository } from '@/app/database/repositories';
import ICustomersRepository from '@/app/database/repositories/ICustomersRepository';
import { CustomersRepository, UserRepository } from '@/app/database/repositories/implementation';
